...
namespace RobotControl
{
    ...
    internal class Action
    {
        ...
        /// </summary>
        /// <param name="p"></param>
        /// <param name="relMov"></param>
        /// <param name="rot"></param>
        /// <param name="relRot"></param>
        /// <param name="mType"></param>
        Action(Point p, bool relMov, Rotation rot, bool relRot, int vel, int zon, MotionType mType)
        {
            // @TODO: check if mType != MotionType.Joints?

            movement = p;
            relativeMovement = relMov;
        ...
        /// <param name="relRot"></param>
        /// <param name="mType"></param>
        Action(double x, double y, double z, bool relMov, double q1, double q2, double q3, double q4, bool relRot, int vel, int zon, MotionType mType) :
            this(new Point(x, y, z), relMov, new Rotation(q1, q2, q3, q4), relRot, vel, zon, mType) {  }
        ...
        public override string ToString()
        {
            ...
            return string.Format("ACTION: {0} {1}-{2} {3}-{4} {5}\\6}", motionType, relativeMovement, movement, relativeRotation, rotation, velocity, zone);
        }
    }
